...
### Quads
To resolve the spectral overlaps with unwanted ions (e.g., ArO^+^+ and ^56^Fe) most of the instrument (especially since 2000s) have included a [collision/reaction cell](@sec-design-crc) that is pressurized with reactive or non-reactive gasses. 


Thermo is vertical [aglient](@https://www.agilent.com/en/product/atomic-spectroscopy/inductively-coupled-plasma-mass-spectrometry-icp-ms/what-is-icp-ms-icp-ms-faqs) is horizontal 
