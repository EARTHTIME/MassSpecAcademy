...
Electrons produced by the emitter are guided through the ionization region by a potential drop from the filament to the ionization region and then to a Faraday cup also mounted external to the ionization region ("the electron trap"). The ionization region is simply a mostly enclosed space held at a high potential relative to ground in order to facilitate the creation of ions at that potential. The potential applied to the ionization region is referred to by several terms including the "accelerating voltage," "ionization energy," or simply the "high voltage."
